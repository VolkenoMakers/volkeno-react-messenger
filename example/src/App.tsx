...
const token =
  'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..4vUb-H6tXZbvctFITzWpxfnlIRq6bZFi8ZeM1OqK9Ms' /* provide the token */
...
const App = () => {
  ...
  return (
    <VolkenoReactMessenger
      ...
      socketUrl={'https://socket-dag.volkeno.com:8804'}
    />
  )
}
