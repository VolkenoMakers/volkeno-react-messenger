...
const token ='eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..KVDb11aPP6YU_JLmLtjuSui7KcPK59IKImKwfamivjQ' /* provide the token */
...
const App = () => {
  ...
  return (
    <VolkenoReactMessenger
      ...
      setApiPostEndpoint={'/api/v1/app/messages'}
      // yad
      ...
      setApiConversationUserEndpoint={`/api/v1/app/conversations-by-user/${user?.user_id}`}
      setStyle='dag'
      isMultiList={false}
